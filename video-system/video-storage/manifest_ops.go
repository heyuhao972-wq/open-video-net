...
func ComputeManifestHash(path string, authorPublicKey string) (string, error) {
...
func SetManifestSignature(path string, authorPublicKey string, signature string) error {
	m, err := loadManifest(path)
	if err != nil {
		return err
	}
